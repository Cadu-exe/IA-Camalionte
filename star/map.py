#MODULO QUE DEFINE O MAPA DA ROMENIA NO FORMATO DE GRAFO CONSIDERANDO A HEURISTICA
    #Classe que define um vertice, como uma cidade tendo seus adjacentes (rotas), 
    #considerando a heuristica (distancia em linha reta do Vertice até Bucareste )
...
class Graph:
    ...
    arad.add_adjacent(Adjacent(arad,75))
    ...
    craiova.add_adjacent(Adjacent(mehadia,120))
