...
class Vertex:
    """
    Classe que define uma vertice, como uma cidade tendo seus adjacentes(rotas),
    e considerando a heuristica (distância em linha reta do vertice at Bucareste)
    """
...
class Graph:
    ...
    timisoara = Vertex("Ttimisoara", 329)
    ...
    oradea.add_adjacent(Adjacent(arad, 71))
